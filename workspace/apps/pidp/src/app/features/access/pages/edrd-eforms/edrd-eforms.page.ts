...
export class EdrdEformsPage implements OnInit {
  ...
  public constructor(
    ...
    private resource: EdredEformsResource,
    private logger: LoggerService,
    private documentService: DocumentService,
  ) {
    const routeData = this.route.snapshot.data;
    this.title = routeData.title;
    this.collectionNotice = documentService.getEdrdEformsCollectionNotice();
    this.completed = routeData.edrdEformsStatusCode === StatusCode.COMPLETED;
