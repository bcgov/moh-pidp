...
import {
  ...
  npdpExceptionalCoverageWebsite,
} from './npdp-exceptional-coverage.constants';

@Component({
  selector: 'app-npdp-exceptional-coverage',
  imports: [
    AsyncPipe,
    BreadcrumbComponent,
    MatButtonModule,
  ...
  templateUrl: './npdp-exceptional-coverage.page.html',
  styleUrl: './npdp-exceptional-coverage.page.scss',
  providers: [
    {
...
export class NpdpExceptionalCoveragePage implements OnInit {
  ...
  public npdp$: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(true);
  public bcProviderStatusCode: number | undefined;
  public npdpStatusCode: number | undefined;
  ...
  public breadcrumbsData: Array<{ title: string; path: string }> = [
    ...
    { title: 'NPDP Exceptional Coverage Form', path: '' },
  ];
  private readonly npdpExceptionalCoverageWebsite: string;

  public constructor() {
    this.selectedIndex = -1;
    this.npdpExceptionalCoverageWebsite = npdpExceptionalCoverageWebsite;
  ...
  public navigateToPath(): void {
    this.navigateToExternalUrl(this.npdpExceptionalCoverageWebsite);
    ...
    profileStatus$
      .pipe(
        tap((profileStatus: ProfileStatus | null) => {
          ...
          if (this.npdpStatusCode === StatusCode.COMPLETED) {
            this.npdp$.next(false);
          } else if (
  ...
  private navigateToExternalUrl(url: string): void {
    this.snowplowService.trackLinkClick(this.npdpExceptionalCoverageWebsite);
