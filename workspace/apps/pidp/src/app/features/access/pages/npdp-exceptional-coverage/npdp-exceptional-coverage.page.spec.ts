...
describe('NpdpExceptionalCoveragePage', () => {
  let component: NpdpExceptionalCoveragePage;
  ...
  beforeEach(() => {
    ...
    component = TestBed.inject(NpdpExceptionalCoveragePage);
  });
