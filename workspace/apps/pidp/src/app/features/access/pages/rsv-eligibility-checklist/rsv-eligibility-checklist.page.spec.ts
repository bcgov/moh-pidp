...
describe('RsvEligibilityChecklistPage', () => {
  let component: RsvEligibilityChecklistPage;
  ...
  beforeEach(() => {
    ...
    component = TestBed.inject(RsvEligibilityChecklistPage);
  });
