...
export class NpdpExceptionalCoveragePortalSection implements IPortalSection {
  ...
  public constructor(
    ...
    this.key = 'npdpExceptionalCoverage';
    this.heading = 'NPDP Exceptional Coverage Form';
    this.description =
  ...
  public get action(): PortalSectionAction {
    ...
    return {
      label: 'View',
      route: AccessRoutes.routePath(AccessRoutes.NPDP_EXCEPTIONAL_COVERAGE),
  ...
  public get status(): string {
    switch (this.getStatusCode()) {
      case StatusCode.AVAILABLE:
        return 'You are eligible to use the NPDP Exceptional Coverage Form';
