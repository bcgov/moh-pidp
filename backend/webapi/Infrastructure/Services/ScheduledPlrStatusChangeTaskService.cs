...
public class ScheduledPlrStatusChangeTaskService : IScheduledPlrStatusChangeTaskService
{
    ...
    private readonly ILogger<ScheduledPlrStatusChangeTaskService> logger;
    ...
    public ScheduledPlrStatusChangeTaskService(
        ...
        ILogger<ScheduledPlrStatusChangeTaskService> logger,
    ...
    public async Task DoWorkAsync(CancellationToken stoppingToken)
    {
        try
        {
                ...
                && !stoppingToken.IsCancellationRequested)
            {
                ...
                {
                    this.logger.LogUnhandledExeption(e);
                }
            }
        }
        catch (OperationCanceledException)
