...
namespace Pidp.Data.Migrations
{
    ...
    [Migration("20260903184258_IMMSBC2")]
    partial class IMMSBC2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pidp.Models.Lookups.AccessType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = 12,
                            Name = "Infant RSV Immunization Request eForm"
                        },
                        new
                        {
                            Code = 13,
                            Name = "Exceptional Coverage: National PharmaCare and Mifepristone/Misoprostol"
                        });
                });
            ...
            modelBuilder.Entity("Pidp.Models.Pharmacy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("PharmaCareCode")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Pidp.Models.PharmacyEnrolment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PharmacyEnrolments");
                });

            modelBuilder.Entity("Pidp.Models.PharmacyPartyRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("PrivacyTrainingAckDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Pidp.Models.AccessRequestRevoked", b =>
                {
                    b.HasBaseType("Pidp.Models.BusinessEvent");
                    ...
                    b.HasDiscriminator().HasValue("AccessRequestRevoked");
                });
            ...
            modelBuilder.Entity("Pidp.Models.BCProviderAttributesUpdated", b =>
                {
                    b.HasBaseType("Pidp.Models.BusinessEvent");
                    ...
                    b.HasDiscriminator().HasValue("BCProviderAttributesUpdated");
                });
            ...
            modelBuilder.Entity("Pidp.Models.Pharmacy", b =>
                {
                    b.HasOne("Pidp.Models.Party", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("Pidp.Models.PharmacyEnrolment", b =>
                {
                    b.HasOne("Pidp.Models.Pharmacy", "Pharmacy")
                        .WithMany("EnrolmentLinks")
