    ...
    public class CommandHandler : ICommandHandler<Command, IDomainResult>
    {
        ...
        public async Task<IDomainResult> HandleAsync(Command command)
        {
            var dataObj = await this.context.Parties
                ...
                .Select(party => new
                {
                    AlreadyEnroled = party.AccessRequests.Any(request => request.AccessTypeCode == AccessTypeCode.Ivf),
            ...
            this.context.AccessRequests.Add(new AccessRequest
            {
                ...
                AccessTypeCode = AccessTypeCode.Ivf,
        ...
        private async Task SendConfirmationEmailAsync(string partyEmail, string firstName)
        {
            ...
            var email = new Email(
                ...
                to: partyEmail,
                subject: "Ivf Enrolment Confirmation",
...
public static partial class IvfLoggingExtensions
{
    [LoggerMessage(1, LogLevel.Warning, "Ivf Access Request for Party {partyId} denied; did not meet all prerequisites.")]
    public static partial void LogAccessRequestDenied(this ILogger<Ivf.CommandHandler> logger, int partyId);
}
